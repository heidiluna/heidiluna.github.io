...
-- CREATE MOVIES TABLE
	...
	CREATE TABLE movies_revenues(
		...
		INSERT INTO movies_revenues (revenue_id, movie_id, domestic_takings, international_takings) 
	...
	select count (*) from directors union
	select count (*) from actors union
	select count (*) from movieS_revenues union 
